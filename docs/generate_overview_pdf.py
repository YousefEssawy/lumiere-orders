...
story.append(bullets([
    "الأوردرات بتيجي من كذا مصدر منفصل — متجر ويلت (وقبله سلر)، واتساب، إنستجرام — من غير مكان واحد يجمعها.",
...
for row in [
    (1, "اجمع الأوردرات",
     "ملف أوردرات المتجر (ويلت أو سلر) بيترفع وبيتحول تلقائياً — محافظات وتليفونات وعناوين — وباقي الأوردرات (واتساب، إنستجرام، وأي مصدر يضيفه الأدمن) بتتسجل من فورم سريع بيختار المنتجات من الكتالوج، والسعر بيتجمع في الـ COD لوحده. وكل أوردر متعلّم يدوي ولا استيراد.",
     PASTEL[3]),
    (2, "راجع وعدّل",
